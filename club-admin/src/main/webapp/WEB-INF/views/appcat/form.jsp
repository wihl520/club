            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form role="form" action="/appcat/edit" method="post" id="form">
                            <div class="box-body">

                                <div class="form-group">
                                    <label for="pid">所属类别</label>
                                    <%--隐藏父ID为后台交互提供参数，通过js赋值--%>
                                    <input type="hidden" class="form-control" value="${appcat.parent.id}" name="parent.id" id="pid" placeholder="所属类别ID">
                                    <input type="text" readonly="readonly" class="form-control" value="${appcat.parent.name}" name="parent.name" id="pname" placeholder="所属类别" data-toggle="modal" data-target="#modal-info">
                                </div>

                                <div class="form-group">
                                    <label for="name">器材(分类)名</label>
                                    <input type="hidden" name="id" value="${appcat.id}">
                                    <input type="text" maxlength="10" minlength="2" required  value="${appcat.name}"  class="form-control" id="name" name="name" placeholder="器材(分类)名">
                                </div>

                                <div class="form-group">
                                    <label for="describe">器材描述</label>
                                    <input type="text" class="form-control" minlength="5" required value="${appcat.describe}" id="describe" name="describe" placeholder="器材描述">
                                </div>

                                <%--使用dropzone上传图片--%>
                                <div class="form-group">
                                    <label for="pic">器材图片</label>
                                    <input type="text" readonly="readonly"   value="${appcat.pic}"  class="form-control" id="pic" name="pic" placeholder="器材图片">
    ...
    var opts={
        ...
        init: function () {
            ...
            this.on("success", function (file, data) {
                ...
                $("#pic").val("http://localhost:8080"+data.data);
            });
        }
    };
    // 关闭 Dropzone 的自动发现功能
