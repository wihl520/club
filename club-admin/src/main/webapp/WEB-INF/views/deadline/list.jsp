    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="row">
                <div class="col-md-12">
                    <div class="box">
                        <form action="/deadline/list" method="get" id="searchForm">
                        ...
                        <div class="box-body ">
                            <table class="table table-bordered">
                               ...
                               <%-- <!--data 对象 -->
                                ...
                                <c:forEach items="${list}" var="deadline" varStatus="status">
                                    <tr>
                                        <td>
                                            <input class="minimal" type="checkbox" name="userCheck" value="${deadline.id}">
                                        </td>
                                        <td>${status.index+1}.</td>
                                        <td>${deadline.memberId}</td>
                                        <td>
                                                ${deadline.name}
                                        </td>
                                        <td><fmt:formatDate value="${deadline.registDate}" pattern="yyyy-MM-dd HH:mm:ss"></fmt:formatDate> </td>
                                        <td><fmt:formatDate value="${deadline.beginDate}" pattern="yyyy-MM-dd HH:mm:ss"></fmt:formatDate> </td>
                                        <td>${deadline.totalDay}</td>
                                        <c:choose>
                                        ...
                                        <td>
                                            <button onclick="toForm('${deadline.id}')" class="btn btn-primary">
                                                <i class="fa fa-edit"></i> 编辑
                                            </button>
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <button onclick="openModal('${deadline.id}')" type="button" class="btn btn-danger" data-toggle="modal" data-target="#modal-danger">
                                                <i class="fa fa-remove"></i> 删除
                                            </button>
                                        </td>
                                    </tr>
...
<script type="text/javascript">
    ...
    function toForm(id) {
        window.location.href="/deadline/form?id="+id;
    }

    function deleteUser() {
        var id=$("#deleteId").val();
        window.location.href="/deadline/delete?id="+id;
    }
