                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box box-primary">
                            ...
                            <form method="post" action="/member/edit">
                                ...
                                <%--密码不能修改，但可以添加--%>
                                <c:if test="${ member.id eq ''}">
                                <div class="form-group">
                                    <label for="password">密码</label>
                                    <input type="password"   required  value="${member.password}" class="form-control" name="password" id="password" placeholder="密码">
                                </div>
                                </c:if>
                                <div class="form-group">
                                    <label >邮箱地址</label>
                                ...
                                <div class="box-footer">
                                    ...
                                    <%--<input type="submit" class="btn btn-info pull-right"  >提交的</input>--%>
