...
<div class="grzxbj">
    <div class="selfinfo center">
       ...
       <form action="/amemdmember" method="post" class="am-form am-form-horizontal" >
               ...
               ${updatamessage}
                ...
                <div class="am-form-group">
                    ...
                    <div class="am-form-content">
                        <input id="user-email" placeholder="Email" type="email"  value="${member.email}" disabled="disabled">
                    </div>
                </div>

           <input type="text" readonly="readonly"    class="form-control" id="pic" name="pic" placeholder="头像">
           <div class="dropzone" id="pic1upload"></div>


                <div class="am-form-group">
                    <label for="user-name2" class="am-form-label">电话</label>
                    <div class="am-form-content">
                        <input type="text" id="user-name2" value="${member.phone}" name="phone" placeholder="请输入你的电话">
                    </div>
                </div>
           <div class="col-md-12">
               <div class="am-form-group">
                   ...
                   <div class="am-form-content sex">
                       <label class="radio-inline">
                           <input type="radio" name="sex1" class="sex" value="men" <c:if test="${member.sex eq 1}">checked</c:if> >男
                       </label>
                       <label class="radio-inline">
                           <input type="radio" name="sex1" class="sex" value="women" <c:if test="${member.sex eq 0}">checked</c:if> >女
                       </label>
                   </div>
                ...
                <div class="am-form-group">
                    ...
                    <div class="am-form-content">
                        <input type="text"  placeholder="请输入你的年龄" name="age" value="${member.age}"  >
                    </div>
                </div>
                <div class="user-email">
                    <label for="user-name2" class="am-form-label" >住址</label>
                    <div class="am-form-content">
                        <input type="text"  value="${member.address}" name="address" placeholder="请输入你的住址" >
                    </div>
                </div>
                <div class="am-form-group">
                    <label for="user-name2" class="am-form-label" >锻炼部位</label>
                    <div class="am-form-content">
                        <input type="text"  value="${member.wantBuild}" name="wantBuild" placeholder="请输入你的锻炼部位" >
                    </div>
                </div>
                <%--<div class="user-email">--%>
