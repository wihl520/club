...
import com.gzqf.clubapi.dao.MemBerDao;
...
public class MemBerServiceImpl extends BaseServiceImpl<Member, MemBerDao> implements MemBerService {
    ...
    @Override
    public Result updateMemberday(Member member) {
        /*成功状态*/
        dao.updateMemberday(member);
        Member byId = dao.getById(member.getId());
        return Result.success("修改会员日期成功！！！",byId);
    }
